...
public class GrassController : MonoBehaviour {
    ...
    void Awake () {
        ...
        //     print("instantiate.....\n");
        //     //Vector3 position = transform.position + new Vector3(Random.Range(-groundWidthHalf, groundWidthHalf), 0, Random.Range(-groundDepthHalf, groundDepthHalf));
        //     Vector3 position = transform.position + new Vector3(0, 0, 10*i);
        //     GameObject newHouse = Instantiate(housesPrefabs[Random.Range(0, housesPrefabs.Count)], position, Quaternion.Euler(0, 0, 0), ground.transform);
        //     //newHouse.transform.localScale = new Vector3(1f, 0.1f, 0.1f);
        //     houses.Add(newHouse);

        //     // position = transform.position + new Vector3(4*i-45, 0, 0);
        //     // newHouse = Instantiate(housesPrefabs[Random.Range(0, housesPrefabs.Count)], position, Quaternion.Euler(0, 90, 0), ground.transform);
        //     // newHouse.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
        //     // houses.Add(newHouse);
